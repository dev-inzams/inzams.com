...
<nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
    ...
    <div class="navbar-nav align-items-center ms-auto">
        ...
        <div class="nav-item"> {{-- use dropdown clase for dropdown --}}
            <a href="{{route('profile.edit')}}" class="nav-link">
                <img class="rounded-circle me-lg-2" src="{{asset('uploads/').'/'.auth()->user()->image}}" alt="" style="width: 40px; height: 40px;">
                <span class="d-none d-lg-inline-flex">{{__(auth()->user()->name)}}</span>
            </a>
