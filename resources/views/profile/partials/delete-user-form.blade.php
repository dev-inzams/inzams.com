...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">{{ __('Delete Account') }}</button>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button class="btn btn-primary py-3  mt-4 mb-4">
                    {{ __('Delete Account') }}
                </x-danger-button>
            </div>
        </form>
